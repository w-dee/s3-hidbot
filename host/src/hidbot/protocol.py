...
HID_UNSUPPORTED_OPERATION = "HID_UNSUPPORTED_OPERATION"
...
class BleProfileId(str, Enum):
    ...
    MOUSE_SIMULATED_SLEEP_V1 = "mouse_simulated_sleep_v1"
...
def validate_ble_profile_list(value: Any) -> tuple[BleFixtureProfile, ...]:
    ...
    for item in profiles:
        ...
        if type(item["bond"]) is not int or item["bond"] not in {0, 1, 2, 3, 4, 5, 6}:
