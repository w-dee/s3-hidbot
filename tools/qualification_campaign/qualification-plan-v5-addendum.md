...
# Authority-v5 qualification preflight and evidence-set amendment

Authority-v5 retains the authority-v4 reset-normalized preflight and evidence
set rules unchanged while binding them to the exact v0.4.0 release candidate.
All product acceptance criteria and Q1 through Q11 workloads remain unchanged.
...
authority-v3 and authority-v4 attempts, rehearsals, runtimes and terminal
