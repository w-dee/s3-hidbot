...
MUTANTS=[
 ...
 ('bond-probe-hide','official_preflight.py','            client.ble_disable()','            None','test_official_preflight.OfficialPreflightTests.test_uninitialized_boot_store_is_probed_and_hidden_again'),
 ('bond-probe-host-isolation','official_preflight.py','original_host_power = _set_bluez_powered(False)','original_host_power = True','test_official_preflight.OfficialPreflightTests.test_uninitialized_boot_store_is_probed_and_hidden_again'),
