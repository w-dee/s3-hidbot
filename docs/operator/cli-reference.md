...
| `hidbotctl ble-profile-list` | UART + `ble.fixture-profile-v1` | List the finite development catalog, including metadata and fixed simulated-sleep mouse variants. Availability is not physical qualification. |
